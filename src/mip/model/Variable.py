...
class Variable:
    ...
    def relaxation_value(self):
        return self._relaxation_value

    @relaxation_value.setter
    def relaxation_value(self, new_value: float):
        self._relaxation_value = new_value
